...
case class GameQueues(
    playersToCreate: ConcurrentListBuffer[PlayerToCreate] = ConcurrentListBuffer(),
    enemiesToCreate: ConcurrentListBuffer[EnemyToCreate] = ConcurrentListBuffer(),
    abilitiesToCreate: ConcurrentListBuffer[AbilityToCreate] = ConcurrentListBuffer(),
    abilityComponentsToCreate: ConcurrentListBuffer[AbilityComponentToCreate] =
      ConcurrentListBuffer(),
    broadcastEvents: ConcurrentListBuffer[GameStateEvent] = ConcurrentListBuffer(),
    ...
    abilityScenarioEvents: ConcurrentListBuffer[AbilityScenarioEvent] = ConcurrentListBuffer()
)
