...
import com.easternsauce.game.gamestate.creature.behavior.EnemyBehavior
...
case class Creature(params: CreatureParams, behavior: CreatureBehavior) extends GameEntity {
